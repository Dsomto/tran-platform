  ...
  STAGE_0: [
    {
      ...
      description:
        "READ THIS FIRST. Stage 0 capstone brief — four deliverables: D1 evidence table, D2 dismissal pattern, D3 business impact (each 3–5 pages), plus D4 required reading + personal reflections (2 pages). Citation bar and submission instructions included. 6 pages.",
      bytes: 13297,
    },
    {
