...
export default async function Stage3RoomPage() {
        ...
        <section className="stage-3-panel p-8 relative overflow-hidden">
          ...
          <div className="flex items-start justify-between gap-4 mb-5 flex-wrap">
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <span className="stage-3-pill">OPENED · {ts}</span>
            </div>
          ...
          <ul className="text-sm text-amber-100/80 leading-relaxed space-y-1.5 list-none">
            <li className="flex gap-2"><span className="text-amber-400/70">›</span> No findings are accepted without a signed hash over the source artefact.</li>
            <li className="flex gap-2"><span className="text-amber-400/70">›</span> Every conclusion must map to a specific MITRE ATT&amp;CK technique ID.</li>
            <li className="flex gap-2"><span className="text-amber-400/70">›</span> Your timeline will be cross-checked against the raw artefacts — do not invent events.</li>
